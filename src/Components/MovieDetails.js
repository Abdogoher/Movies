        ...
        <Row className='justify-content-center'>
              <Col md="12" sm="12" xs="12" className='mt-4'>
                  <div className='card-detalis d-flex align-items-center'>
                      <img className='img-movie w-30' src={`https://image.tmdb.org/t/p/w500/` + movie.poster_path} alt='hgh' />
                      <div className='justify-content-center text-center  mx-auto'>
                          ...
                          <p className='card-text-details border-bottom'>عددالمقيمين :{ movie.vote_count}</p>
                          <p className='card-text-details border-bottom'>النقييم : { movie.vote_average}</p>
                      </div>
                  </div>
              </Col>      
          </Row>
          <Row className='justify-content-center'>
              <Col md="12" xs="12" sm="12" className='mt-1'>
                  <div className='card-story d-flex flex-column align-items-start'>
                      ...
                      <div className='card-text-title border-bottom'>
